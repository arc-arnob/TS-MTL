...
class CAGradTrainer:
    """
    Trainer with CAGrad (Conflict-Averse Gradient Descent) to handle conflicting gradients
    between different client tasks.
    """
    def __init__(self, model, learning_rate=0.001, device=None, 
                 cagrad_c=0.4, grad_clip=1.0):
        self.model = model
    ...
    def train_step(self, batch):
        """Perform a single training step with CAGrad."""
        # Unpack batch data
