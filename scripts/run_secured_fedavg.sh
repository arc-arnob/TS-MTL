...
# Privacy-Preserving Federated Learning for Air Quality via CLI
# This script runs secured federated averaging with differential privacy and secure aggregation

python -m TS_MTL.cli \
    federated=true \
    trainer.name=secured_fedavg \
...
echo "Secured federated learning completed at: $(date)"
echo "=== Privacy-Preserving Federated Learning Complete ==="
